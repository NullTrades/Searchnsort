...
/**
 * last steps
 * - make the "reset to original" option delete the adjusted-CSV file
 * - add the ability to remove a game from the collection
 * - color formatting for the console output
 * - space(gaps) formatting for the console output
 */
